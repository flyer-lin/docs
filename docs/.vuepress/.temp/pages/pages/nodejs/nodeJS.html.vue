<template><div><p><a name="bgs4e"></a></p>
<h2 id="buffer-缓冲器" tabindex="-1"><a class="header-anchor" href="#buffer-缓冲器" aria-hidden="true">#</a> Buffer（缓冲器）</h2>
<p><a name="QGT37"></a></p>
<h3 id="_1-概念" tabindex="-1"><a class="header-anchor" href="#_1-概念" aria-hidden="true">#</a> 1.概念</h3>
<p>Buffer 是一个类似于数组的<strong>对象</strong>，用于表示固定长度的字节序列 Buffer 本质是一段内存空间，专门用来处理<strong>二进制数据</strong>。<br /><img src="https://cdn.nlark.com/yuque/0/2023/png/22527936/1681884892716-90036351-92e0-4c1a-8e38-7705574790b9.png#averageHue=%23e8eaea&amp;clientId=u29c119ba-f12f-4&amp;from=paste&amp;height=198&amp;id=ua350788a&amp;originHeight=198&amp;originWidth=927&amp;originalType=binary&amp;ratio=1&amp;rotation=0&amp;showTitle=false&amp;size=26188&amp;status=done&amp;style=none&amp;taskId=ue1e48952-2618-426f-98a8-1459259e476&amp;title=&amp;width=927" alt="image.png">
<a name="tybUC"></a></p>
...
<p><img src="https://cdn.nlark.com/yuque/0/2023/png/22527936/1681884952223-8c6d0bda-144e-47b1-98ef-078baaa11263.png#averageHue=%23151e2e&amp;clientId=u29c119ba-f12f-4&amp;from=paste&amp;height=155&amp;id=u0a48b03b&amp;originHeight=155&amp;originWidth=927&amp;originalType=binary&amp;ratio=1&amp;rotation=0&amp;showTitle=false&amp;size=78831&amp;status=done&amp;style=none&amp;taskId=u6b66b8a2-c660-48b0-9b6c-e6db9a57944&amp;title=&amp;width=927" alt="image.png">
<a name="Gmtv6"></a></p>
<h3 id="_3-使用" tabindex="-1"><a class="header-anchor" href="#_3-使用" aria-hidden="true">#</a> 3.使用</h3>
<p><a name="o2KqZ"></a></p>
<h4 id="_1-创建buffer" tabindex="-1"><a class="header-anchor" href="#_1-创建buffer" aria-hidden="true">#</a> 1.创建Buffer</h4>
<p>Node.js 中创建 Buffer 的方式主要如下几种：</p>
<ol>
<li>Buffer.alloc</li>
</ol>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//创建了一个长度为 10 字节的 Buffer，相当于申请了 10 字节的内存空间，每个字节的值为 0 </span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//创建了一个长度为 10 字节的 Buffer，buffer 中可能存在旧的数据, 可能会影响执行结果，</span>
<span class="token comment">//所以叫 unsafe</span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//通过字符串创建 Buffer</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="zkfkR"></a></p>
<h4 id="_2-buffer-与字符串的转化" tabindex="-1"><a class="header-anchor" href="#_2-buffer-与字符串的转化" aria-hidden="true">#</a> 2.Buffer 与字符串的转化</h4>
<p>我们可以借助 toString 方法将 Buffer 转为字符串</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">let</span> buf_4 <span class="token operator">=</span> Buffer<span class="token punctuation">.</span><span class="token function">from</span><span class="token punctuation">(</span><span class="token punctuation">[</span><span class="token number">105</span><span class="token punctuation">,</span> <span class="token number">108</span><span class="token punctuation">,</span> <span class="token number">111</span><span class="token punctuation">,</span> <span class="token number">118</span><span class="token punctuation">,</span> <span class="token number">101</span><span class="token punctuation">,</span> <span class="token number">121</span><span class="token punctuation">,</span> <span class="token number">111</span><span class="token punctuation">,</span> <span class="token number">117</span><span class="token punctuation">]</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>toString 默认是按照 utf-8 编码方式进行转换的。
<a name="gCbSD"></a></p>
<h4 id="_3-buffer-的读写" tabindex="-1"><a class="header-anchor" href="#_3-buffer-的读写" aria-hidden="true">#</a> 3.Buffer 的读写</h4>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//读取</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注意:</p>
<ol>
<li>如果修改的数值超过 255 ，则超过 8 位数据会被舍弃</li>
<li>一个 utf-8 的字符 一般 占 3 个字节
<a name="tABYD"></a></li>
</ol>
<h2 id="fs模块" tabindex="-1"><a class="header-anchor" href="#fs模块" aria-hidden="true">#</a> fs模块</h2>
<p>fs 全称为 file system ，称之为文件系统，是 Node.js 中的内置模块，可以对计算机中的磁盘进行操作。
<a name="Hwjva"></a></p>
<h3 id="_1-文件写入" tabindex="-1"><a class="header-anchor" href="#_1-文件写入" aria-hidden="true">#</a> 1.文件写入</h3>
<p>文件写入就是将数据保存到文件中</p>
<table>
<thead>
<tr>
...
<p><a name="F8u1v"></a></p>
<h4 id="_1-writefile-异步写入" tabindex="-1"><a class="header-anchor" href="#_1-writefile-异步写入" aria-hidden="true">#</a> 1.writeFile 异步写入</h4>
...
<p>返回值： undefined</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// require 是 Node.js 环境中的'全局'变量，用来导入模块</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="zoaqn"></a></p>
<h4 id="_2-writefilesync-同步写入" tabindex="-1"><a class="header-anchor" href="#_2-writefilesync-同步写入" aria-hidden="true">#</a> 2.writeFileSync 同步写入</h4>
<p>语法: fs.writeFileSync(file, data[, options])<br />参数与 fs.writeFile 大体一致，只是没有 callback 参数<br />返回值： undefined</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">try</span><span class="token punctuation">{</span>
	fs<span class="token punctuation">.</span><span class="token function">writeFileSync</span><span class="token punctuation">(</span><span class="token string">'./座右铭.txt'</span><span class="token punctuation">,</span> <span class="token string">'三人行，必有我师焉。'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span><span class="token keyword">catch</span><span class="token punctuation">(</span>e<span class="token punctuation">)</span><span class="token punctuation">{</span>
	console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>e<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Node.js 中的磁盘操作是由其他线程完成的，结果的处理有两种模式：</p>
<ul>
<li>同步处理 JavaScript 主线程会等待其他线程的执行结果，然后再继续执行主线程的代码，效率较低</li>
<li>异步处理 JavaScript 主线程不会等待其他线程的执行结果，直接执行后续的主线程代码，效率较好
<a name="XXlAS"></a></li>
</ul>
<h4 id="_3-appendfile-appendfilesync-追加写入" tabindex="-1"><a class="header-anchor" href="#_3-appendfile-appendfilesync-追加写入" aria-hidden="true">#</a> 3.appendFile / appendFileSync 追加写入</h4>
<p>appendFile 作用是在文件尾部追加内容，appendFile 语法与 writeFile 语法完全相同<br />语法:<br />fs.appendFile(file, data[, options], callback)<br />fs.appendFileSync(file, data[, options])<br />返回值： 二者都为 undefined</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>fs<span class="token punctuation">.</span><span class="token function">appendFile</span><span class="token punctuation">(</span><span class="token string">'./座右铭.txt'</span><span class="token punctuation">,</span><span class="token string">'择其善者而从之，其不善者而改之。'</span><span class="token punctuation">,</span> <span class="token parameter">err</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="jty82"></a></p>
<h4 id="_4-createwritestream-流式写入" tabindex="-1"><a class="header-anchor" href="#_4-createwritestream-流式写入" aria-hidden="true">#</a> 4.createWriteStream 流式写入</h4>
<p>语法： fs.createWriteStream(path[, options])<br />参数说明：<br />path 文件路径<br />options 选项配置（可选）<br />返回值： Object</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">let</span> ws <span class="token operator">=</span> fs<span class="token punctuation">.</span><span class="token function">createWriteStream</span><span class="token punctuation">(</span><span class="token string">'./观书有感.txt'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>程序打开一个文件是需要消耗资源的，流式写入可以减少打开关闭文件的次数。<br />流式写入方式适用于大文件写入或者频繁写入的场景, writeFile 适合于写入频率较低的场景
<a name="m2jRZ"></a></p>
<h4 id="_5-写入文件的场景" tabindex="-1"><a class="header-anchor" href="#_5-写入文件的场景" aria-hidden="true">#</a> 5.写入文件的场景</h4>
...
<p>当需要持久化保存数据的时候，应该想到文件写入
<a name="R2pOU"></a></p>
<h3 id="_2-文件读取" tabindex="-1"><a class="header-anchor" href="#_2-文件读取" aria-hidden="true">#</a> 2.文件读取</h3>
...
<p><a name="nJb4w"></a></p>
<h4 id="_1-readfile-异步读取" tabindex="-1"><a class="header-anchor" href="#_1-readfile-异步读取" aria-hidden="true">#</a> 1.readFile 异步读取</h4>
...
<p>返回值： undefined</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//导入 fs 模块</span>
<span class="token keyword">const</span> fs <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">'fs'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
fs<span class="token punctuation">.</span><span class="token function">readFile</span><span class="token punctuation">(</span><span class="token string">'./座右铭.txt'</span><span class="token punctuation">,</span> <span class="token string">'utf-8'</span><span class="token punctuation">,</span><span class="token punctuation">(</span><span class="token parameter">err<span class="token punctuation">,</span> data</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
  ...
  console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>data<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="IB8ws"></a></p>
<h4 id="_2-readfilesync-同步读取" tabindex="-1"><a class="header-anchor" href="#_2-readfilesync-同步读取" aria-hidden="true">#</a> 2.readFileSync 同步读取</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="MIx6X"></a></p>
<h4 id="_3-createreadstream-流式读取" tabindex="-1"><a class="header-anchor" href="#_3-createreadstream-流式读取" aria-hidden="true">#</a> 3.createReadStream 流式读取</h4>
...
<p>返回值： Object</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//创建读取流对象</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="e0y8p"></a></p>
<h4 id="_4-读取文件应用场景" tabindex="-1"><a class="header-anchor" href="#_4-读取文件应用场景" aria-hidden="true">#</a> 4.读取文件应用场景</h4>
<ul>
<li>电脑开机</li>
<li>程序运行</li>
<li>编辑器打开文件</li>
...
<h3 id="_3-文件移动与重命名" tabindex="-1"><a class="header-anchor" href="#_3-文件移动与重命名" aria-hidden="true">#</a> 3.文件移动与重命名</h3>
<p>在 Node.js 中，我们可以使用 rename 或 renameSync 来移动或重命名文件或文件夹<br />语法：<br />fs.rename(oldPath, newPath, callback)<br />fs.renameSync(oldPath, newPath)<br />参数说明：</p>
<ul>
<li>oldPath 文件当前的路径</li>
<li>newPath 文件新的路径</li>
<li>callback 操作后的回调</li>
</ul>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>fs<span class="token punctuation">.</span><span class="token function">rename</span><span class="token punctuation">(</span><span class="token string">'./观书有感.txt'</span><span class="token punctuation">,</span> <span class="token string">'./论语/观书有感.txt'</span><span class="token punctuation">,</span> <span class="token punctuation">(</span><span class="token parameter">err</span><span class="token punctuation">)</span> <span class="token operator">=></span><span class="token punctuation">{</span>
	<span class="token keyword">if</span><span class="token punctuation">(</span>err<span class="token punctuation">)</span> <span class="token keyword">throw</span> err<span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="FOQYj"></a></p>
<h3 id="_4-文件删除" tabindex="-1"><a class="header-anchor" href="#_4-文件删除" aria-hidden="true">#</a> 4.文件删除</h3>
<p>在 Node.js 中，我们可以使用 unlink 或 unlinkSync 来删除文件<br />语法：<br />fs.unlink(path, callback)<br />fs.unlinkSync(path)<br />参数说明：</p>
<ul>
<li>path 文件路径</li>
<li>callback 操作后的回调</li>
</ul>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
fs<span class="token punctuation">.</span><span class="token function">unlinkSync</span><span class="token punctuation">(</span><span class="token string">'./test2.txt'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="pChb5"></a></p>
<h3 id="_5-文件夹操作" tabindex="-1"><a class="header-anchor" href="#_5-文件夹操作" aria-hidden="true">#</a> 5.文件夹操作</h3>
...
<p><a name="SrYYy"></a></p>
<h4 id="_1-mkdir-创建文件夹" tabindex="-1"><a class="header-anchor" href="#_1-mkdir-创建文件夹" aria-hidden="true">#</a> 1.mkdir 创建文件夹</h4>
<p>在 Node.js 中，我们可以使用 mkdir 或 mkdirSync 来创建文件夹<br />语法：<br />fs.mkdir(path[, options], callback)<br />fs.mkdirSync(path[, options])<br />参数说明：</p>
<ul>
<li>path 文件夹路径</li>
<li>options 选项配置（ 可选）</li>
<li>callback 操作后的回调</li>
</ul>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//异步创建文件夹</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="nx6Oy"></a></p>
<h4 id="_2-readdir-读取文件夹" tabindex="-1"><a class="header-anchor" href="#_2-readdir-读取文件夹" aria-hidden="true">#</a> 2.readdir 读取文件夹</h4>
<p>在 Node.js 中，我们可以使用 rmdir 或 rmdirSync 来删除文件夹<br />语法：<br />fs.rmdir(path[, options], callback)<br />fs.rmdirSync(path[, options])<br />参数说明：</p>
<ul>
<li>path 文件夹路径</li>
<li>options 选项配置（ 可选）</li>
<li>callback 操作后的回调</li>
</ul>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//异步删除文件夹</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="zEY23"></a></p>
<h3 id="_6-查看资源状态" tabindex="-1"><a class="header-anchor" href="#_6-查看资源状态" aria-hidden="true">#</a> 6.查看资源状态</h3>
<p>在 Node.js 中，我们可以使用 stat 或 statSync 来查看资源的详细信息<br />语法：<br />fs.stat(path[, options], callback)<br />fs.statSync(path[, options])<br />参数说明：</p>
<ul>
<li>path 文件夹路径</li>
<li>options 选项配置（ 可选）</li>
<li>callback 操作后的回调</li>
</ul>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//异步获取状态</span>
...
<span class="token keyword">let</span> data <span class="token operator">=</span> fs<span class="token punctuation">.</span><span class="token function">statSync</span><span class="token punctuation">(</span><span class="token string">'./data.txt'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="fJ5gf"></a></p>
<h3 id="_7-相对路径问题" tabindex="-1"><a class="header-anchor" href="#_7-相对路径问题" aria-hidden="true">#</a> 7.相对路径问题</h3>
...
<p>相对路径中所谓的当前目录，指的是命令行的工作目录，而并非是文件的所在目录<br />所以当命令行的工作目录与文件所在目录不一致时，会出现一些 BUG
<a name="qfN12"></a></p>
<h3 id="_8-dirname" tabindex="-1"><a class="header-anchor" href="#_8-dirname" aria-hidden="true">#</a> 8.__dirname</h3>
<p>__dirname 与 require 类似，都是 Node.js 环境中的'全局'变量<br />__dirname 保存着当前文件所在目录的绝对路径，可以使用 __dirname 与文件名拼接成绝对路径</p>
...
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>data<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>使用 fs 模块的时候，尽量使用 __dirname 将路径转化为绝对路径，这样可以避免相对路径产生的Bug
<a name="I5wyc"></a></p>
<h2 id="path-模块" tabindex="-1"><a class="header-anchor" href="#path-模块" aria-hidden="true">#</a> path 模块</h2>
<p>path 模块提供了操作路径的功能</p>
<table>
<thead>
<tr>
<th>API</th>
...
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>path<span class="token punctuation">.</span><span class="token function">extname</span><span class="token punctuation">(</span>pathname<span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="zbqjQ"></a></p>
<h2 id="http-协议" tabindex="-1"><a class="header-anchor" href="#http-协议" aria-hidden="true">#</a> HTTP 协议</h2>
<p><a name="Fvv3Z"></a></p>
<h3 id="_1-概念-1" tabindex="-1"><a class="header-anchor" href="#_1-概念-1" aria-hidden="true">#</a> 1.概念</h3>
<p>HTTP（hypertext transport protocol）协议；中文叫超文本传输协议<br />是一种基于TCP/IP的应用层通信协议<br />这个协议详细规定了浏览器和万维网服务器之间互相通信的规则。<br />协议中主要规定了两个方面的内容<br />客户端：用来向服务器发送数据，可以被称之为请求报文<br />服务端：向客户端返回数据，可以被称之为响应报文<br />报文：可以简单理解为就是一堆字符串
<a name="naqi7"></a></p>
<h3 id="_2-请求报文的组成" tabindex="-1"><a class="header-anchor" href="#_2-请求报文的组成" aria-hidden="true">#</a> 2.请求报文的组成</h3>
<ul>
<li>请求行</li>
<li>请求头</li>
<li>空行</li>
...
<h3 id="_3-http-的请求行" tabindex="-1"><a class="header-anchor" href="#_3-http-的请求行" aria-hidden="true">#</a> 3.HTTP 的请求行</h3>
<ul>
<li>请求方法（get、post、put、delete等）</li>
<li>请求 URL（统一资源定位器）</li>
</ul>
<p>例如： <a href="http://www.baidu.com:80/index.html?a=100&amp;b=200#logo" target="_blank" rel="noopener noreferrer">http://www.baidu.com:80/index.html?a=100&amp;b=200#logo<ExternalLinkIcon/></a></p>
<ul>
...
<h3 id="_4-http-请求头" tabindex="-1"><a class="header-anchor" href="#_4-http-请求头" aria-hidden="true">#</a> 4.HTTP 请求头</h3>
<p>格式：『头名：头值』<br />常见的请求头有：</p>
<table>
<thead>
<tr>
<th>请求头</th>
...
<p><a name="PVFJb"></a></p>
<h3 id="_5-http-的请求体" tabindex="-1"><a class="header-anchor" href="#_5-http-的请求体" aria-hidden="true">#</a> 5.HTTP 的请求体</h3>
<p>请求体内容的格式是非常灵活的，<br />（可以是空）==&gt; GET请求，<br />（也可以是字符串，还可以是JSON）===&gt; POST请求<br />例如：</p>
<ul>
<li>字符串：keywords=手机&amp;price=2000</li>
<li>JSON：{&quot;keywords&quot;:&quot;手机&quot;,&quot;price&quot;:2000}
<a name="Yh21z"></a></li>
</ul>
<h3 id="_6-响应报文的组成" tabindex="-1"><a class="header-anchor" href="#_6-响应报文的组成" aria-hidden="true">#</a> 6.响应报文的组成</h3>
<ul>
<li>响应行
<ul>
<li>HTTP/1.1：HTTP协议版本号</li>
<li>200：响应状态码 404 Not Found 500 Internal Server Error还有一些状态码，<a href="https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Status" target="_blank" rel="noopener noreferrer">参考<ExternalLinkIcon/></a></li>
<li>OK：响应状态描述</li>
</ul>
</li>
</ul>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>Cache<span class="token operator">-</span>Control<span class="token operator">:</span>缓存控制 <span class="token keyword">private</span> 私有的，只允许客户端缓存数据
Connection 链接设置
Content<span class="token operator">-</span>Type<span class="token operator">:</span>text<span class="token operator">/</span>html<span class="token punctuation">;</span>charset<span class="token operator">=</span>utf<span class="token operator">-</span><span class="token number">8</span> 设置响应体的数据类型以及字符集<span class="token punctuation">,</span>响应体为html，字符集
utf<span class="token operator">-</span><span class="token number">8</span>
Content<span class="token operator">-</span>Length<span class="token operator">:</span>响应体的长度，单位为字节
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li>空行</li>
<li>响应体</li>
</ul>
<p>响应体内容的类型是非常灵活的，常见的类型有 HTML、CSS、JS、图片、JSON
<a name="mc5Gk"></a></p>
<h3 id="_7-创建-http-服务" tabindex="-1"><a class="header-anchor" href="#_7-创建-http-服务" aria-hidden="true">#</a> 7.创建 HTTP 服务</h3>
<p>使用 nodejs 创建 HTTP 服务
<a name="uGSlj"></a></p>
<h4 id="_1-操作步骤" tabindex="-1"><a class="header-anchor" href="#_1-操作步骤" aria-hidden="true">#</a> 1.操作步骤</h4>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//1. 导入 http 模块</span>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>http.createServer 里的回调函数的执行时机： 当接收到 HTTP 请求的时候，就会执行
<a name="kcK3i"></a></p>
<h4 id="_2-测试" tabindex="-1"><a class="header-anchor" href="#_2-测试" aria-hidden="true">#</a> 2.测试</h4>
<p>浏览器请求对应端口 http://127.0.0.1:9000
<a name="hWYDF"></a></p>
<h4 id="_3-注意事项" tabindex="-1"><a class="header-anchor" href="#_3-注意事项" aria-hidden="true">#</a> 3.注意事项</h4>
<ol>
<li>命令行 ctrl + c 停止服务</li>
<li>当服务启动后，更新代码必须重启服务才能生效</li>
<li>响应内容中文乱码的解决办法</li>
<li>端口号被占用<br />1）关闭当前正在运行监听端口的服务 （ 使用较多）<br />2）修改其他端口号</li>
<li>HTTP 协议默认端口是 80 。HTTPS 协议的默认端口是 443, HTTP 服务开发常用端口有 3000，<br />8080，8090，9000 等<br />如果端口被其他程序占用，可以使用资源监视器找到占用端口的程序，然后使用任务管理器关闭<br />对应的程序
<a name="YBPhG"></a></li>
</ol>
<h3 id="_8-浏览器查看-http-报文" tabindex="-1"><a class="header-anchor" href="#_8-浏览器查看-http-报文" aria-hidden="true">#</a> 8.浏览器查看 HTTP 报文</h3>
<p><img src="https://cdn.nlark.com/yuque/0/2023/png/22527936/1681891607118-d3f054c2-e74b-4e94-a61c-6581c4b7f75c.png#averageHue=%23ddc296&amp;clientId=uef4be2d9-8c92-4&amp;from=paste&amp;height=432&amp;id=ua6cb412c&amp;originHeight=432&amp;originWidth=1920&amp;originalType=binary&amp;ratio=1&amp;rotation=0&amp;showTitle=false&amp;size=46711&amp;status=done&amp;style=none&amp;taskId=u60fb8def-8b67-4701-8f5a-17ad4a61a66&amp;title=&amp;width=1920" alt="image.png">1.查看请求行与请求头<br /><img src="https://cdn.nlark.com/yuque/0/2023/png/22527936/1681891626766-fc2c13ae-ccf7-431d-98ef-3b9c4db6d3b0.png#averageHue=%2376624a&amp;clientId=uef4be2d9-8c92-4&amp;from=paste&amp;height=713&amp;id=ua124b780&amp;originHeight=713&amp;originWidth=1920&amp;originalType=binary&amp;ratio=1&amp;rotation=0&amp;showTitle=false&amp;size=109036&amp;status=done&amp;style=none&amp;taskId=ub74e3170-deb3-4731-a7fa-7b22c8c065b&amp;title=&amp;width=1920" alt="image.png">
<a name="Mcb3N"></a></p>
<h4 id="_2-查看请求体" tabindex="-1"><a class="header-anchor" href="#_2-查看请求体" aria-hidden="true">#</a> 2. 查看请求体</h4>
<p><img src="https://cdn.nlark.com/yuque/0/2023/png/22527936/1681891632340-c75ffb66-2efa-403e-9673-167766b165b5.png#averageHue=%23f9f9f9&amp;clientId=uef4be2d9-8c92-4&amp;from=paste&amp;height=713&amp;id=udc49e1cf&amp;originHeight=713&amp;originWidth=1920&amp;originalType=binary&amp;ratio=1&amp;rotation=0&amp;showTitle=false&amp;size=62565&amp;status=done&amp;style=none&amp;taskId=u93494120-8a7a-4a87-b4f2-3e9141baf2a&amp;title=&amp;width=1920" alt="image.png">
<a name="Oq6de"></a></p>
<h4 id="_3-查看-url-查询字符串" tabindex="-1"><a class="header-anchor" href="#_3-查看-url-查询字符串" aria-hidden="true">#</a> 3. 查看 URL 查询字符串</h4>
<p><img src="https://cdn.nlark.com/yuque/0/2023/png/22527936/1681891680636-a47efc96-c032-4a19-ae7c-d6892ea81195.png#averageHue=%23fbfbfb&amp;clientId=uef4be2d9-8c92-4&amp;from=paste&amp;height=713&amp;id=u02f17ad5&amp;originHeight=713&amp;originWidth=1920&amp;originalType=binary&amp;ratio=1&amp;rotation=0&amp;showTitle=false&amp;size=63625&amp;status=done&amp;style=none&amp;taskId=u15b4b21f-7c21-41f4-96d5-93bb3cf3038&amp;title=&amp;width=1920" alt="image.png">
<a name="O5qr2"></a></p>
<h4 id="_4-查看响应行与响应头" tabindex="-1"><a class="header-anchor" href="#_4-查看响应行与响应头" aria-hidden="true">#</a> 4.查看响应行与响应头</h4>
<p><img src="https://cdn.nlark.com/yuque/0/2023/png/22527936/1681891706518-8cb7c722-9258-416d-bb59-f4f9f76be026.png#averageHue=%23e6c086&amp;clientId=uef4be2d9-8c92-4&amp;from=paste&amp;height=562&amp;id=ud07ea98a&amp;originHeight=562&amp;originWidth=1920&amp;originalType=binary&amp;ratio=1&amp;rotation=0&amp;showTitle=false&amp;size=67306&amp;status=done&amp;style=none&amp;taskId=ubeaaec7d-086c-46fc-9fca-0ea9b9dced8&amp;title=&amp;width=1920" alt="image.png">
<a name="KmyKm"></a></p>
<h4 id="_5-查看响应体" tabindex="-1"><a class="header-anchor" href="#_5-查看响应体" aria-hidden="true">#</a> 5.查看响应体</h4>
<p><img src="https://cdn.nlark.com/yuque/0/2023/png/22527936/1681891733277-07cc146e-d2d8-48c4-a09b-687d7cd07bb5.png#averageHue=%23ecbf79&amp;clientId=uef4be2d9-8c92-4&amp;from=paste&amp;height=713&amp;id=uf8afecb6&amp;originHeight=713&amp;originWidth=1920&amp;originalType=binary&amp;ratio=1&amp;rotation=0&amp;showTitle=false&amp;size=72271&amp;status=done&amp;style=none&amp;taskId=uc058c8c4-3fd3-4614-a6f5-8e542e18660&amp;title=&amp;width=1920" alt="image.png">
<a name="X3fmT"></a></p>
<h3 id="_9-获取-http-请求报文" tabindex="-1"><a class="header-anchor" href="#_9-获取-http-请求报文" aria-hidden="true">#</a> 9.获取 HTTP 请求报文</h3>
...
<tr>
<td>URL路径</td>
<td>request('url').parse(request.url,true).pathName</td>
</tr>
<tr>
<td>URL查询字符串</td>
<td>request('url').parse(request.url,true).query</td>
</tr>
<tr>
<td>请求头</td>
...
<tr>
<td>request.on('data', data =&gt; {</td>
<td></td>
</tr>
</tbody>
</table>
<pre><code>    body += data.toString()
})
request.on('end', () =&gt; {
    console.log(body);
});
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="I9JOV"></a></p>
<h2 id="管理发布包" tabindex="-1"><a class="header-anchor" href="#管理发布包" aria-hidden="true">#</a> 管理发布包</h2>
<p><a name="qsqrU"></a></p>
<h3 id="创建与发布" tabindex="-1"><a class="header-anchor" href="#创建与发布" aria-hidden="true">#</a> 创建与发布</h3>
<p>我们可以将自己开发的工具包发布到 npm 服务上，方便自己和其他开发者使用，操作步骤如下:</p>
<p>:::tips</p>
<ol>
<li>创建文件夹，并创建文件index.js，在文件中声明函数，使用module.exports暴露 2. npm初始化工具包，package.json填写包的信息(包的名字是唯一的)</li>
<li>注册账号 <a href="https://www.npmjs.com/signup" target="_blank" rel="noopener noreferrer">https://www.npmjs.com/signup<ExternalLinkIcon/></a></li>
<li>激活账号(一定要激活账号)</li>
<li>修改为官方的官方镜像</li>
<li>命令行下 npm login 填写相关用户信息</li>
<li>命令行下 npm publish 提交包
:::
<a name="a08g4"></a></li>
</ol>
<h3 id="_2-更新包" tabindex="-1"><a class="header-anchor" href="#_2-更新包" aria-hidden="true">#</a> 2.更新包</h3>
<p>后续可以对自己发布的包进行更新，操作步骤如下</p>
<ol>
<li>更新包中的代码</li>
<li>测试代码是否可用</li>
<li>修改 package.json 中的版本号</li>
<li>发布更新  npm publish	 	 		
<a name="bm9Kw"></a></li>
</ol>
<h3 id="_3-删除包" tabindex="-1"><a class="header-anchor" href="#_3-删除包" aria-hidden="true">#</a> 3.删除包</h3>
<p>npm unpublish --force
<a name="unl3R"></a></p>
<h2 id="express" tabindex="-1"><a class="header-anchor" href="#express" aria-hidden="true">#</a> express</h2>
...
app<span class="token punctuation">.</span><span class="token function">get</span><span class="token punctuation">(</span><span class="token string">"/home"</span><span class="token punctuation">,</span> <span class="token punctuation">(</span><span class="token parameter">req<span class="token punctuation">,</span> res</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
  ...
  <span class="token comment">//express 操作</span>
...
app<span class="token punctuation">.</span><span class="token function">get</span><span class="token punctuation">(</span><span class="token string">"/about"</span><span class="token punctuation">,</span> <span class="token punctuation">(</span><span class="token parameter">req<span class="token punctuation">,</span> res</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
  <span class="token comment">//原生</span>
  <span class="token comment">// res.statusCode = 400;</span>
  <span class="token comment">// res.statusMessage = "not found"</span>
  <span class="token comment">// res.setHeader("Content-Type", "text/html;charset=utf-8");</span>
  <span class="token comment">// res.write("hello111");</span>
  <span class="token comment">// res.end("hello");</span>
  <span class="token comment">//express</span>
  <span class="token comment">//自动添加res.setHeader("Content-Type", "text/html;charset=utf-8");中文不会乱码</span>
  res<span class="token punctuation">.</span><span class="token function">status</span><span class="token punctuation">(</span><span class="token number">500</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">set</span><span class="token punctuation">(</span><span class="token string">'aaa'</span><span class="token punctuation">,</span><span class="token string">'bbb'</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">end</span><span class="token punctuation">(</span><span class="token string">"hello"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="AgKEK"></a></p>
<h3 id="_1-express中间件" tabindex="-1"><a class="header-anchor" href="#_1-express中间件" aria-hidden="true">#</a> 1.express中间件</h3>
<p>中间件(Middleware)本质是一个回调函数<br />中间件函数 可以像路由回调一样访问 请求对象(request) ， 响应对象(response) 				   中间件的作用 就是 使用函数封装公共操作，简化代码
:::tips
全局中间件<br />路由中间件
:::
每一个请求 到达服务端之后 都会执行全局中间件函数</p>
<p><img src="https://cdn.nlark.com/yuque/0/2023/png/22527936/1686120610288-e2c99671-dbec-4289-9027-c94bd82254eb.png#averageHue=%23f4f3f3&amp;clientId=udefaf894-88fd-4&amp;from=paste&amp;height=906&amp;id=uc88b44f3&amp;originHeight=906&amp;originWidth=1666&amp;originalType=binary&amp;ratio=1&amp;rotation=0&amp;showTitle=false&amp;size=241199&amp;status=done&amp;style=none&amp;taskId=u555df131-e77f-4bf9-8c0c-593ef6c2156&amp;title=&amp;width=1666" alt="image.png"><br />声明时可以直接将匿名函数传递给 use</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>app<span class="token punctuation">.</span><span class="token function">use</span><span class="token punctuation">(</span><span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token parameter">request<span class="token punctuation">,</span> response<span class="token punctuation">,</span> next</span><span class="token punctuation">)</span> <span class="token punctuation">{</span> 
...
app<span class="token punctuation">.</span><span class="token function">use</span><span class="token punctuation">(</span><span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token parameter">request<span class="token punctuation">,</span> response<span class="token punctuation">,</span> next</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token function">next</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span> 
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="lZmHY"></a></p>
<h4 id="_1-定义路由中间件" tabindex="-1"><a class="header-anchor" href="#_1-定义路由中间件" aria-hidden="true">#</a> 1.定义路由中间件</h4>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>如果 只需要对某一些路由进行功能封装 ，则就需要路由中间件
app<span class="token punctuation">.</span><span class="token function">get</span><span class="token punctuation">(</span><span class="token string">'/路径'</span><span class="token punctuation">,</span><span class="token template-string"><span class="token template-punctuation string">`</span><span class="token string">中间件函数</span><span class="token template-punctuation string">`</span></span><span class="token punctuation">,</span><span class="token punctuation">(</span><span class="token parameter">request<span class="token punctuation">,</span>response</span><span class="token punctuation">)</span><span class="token operator">=></span><span class="token punctuation">{</span> <span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span> 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a name="k5Wnq"></a></p>
<h4 id="_2-静态资源中间件" tabindex="-1"><a class="header-anchor" href="#_2-静态资源中间件" aria-hidden="true">#</a> 2.静态资源中间件</h4>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//引入express框架 </span>
...
<span class="token comment">//当然这个目录中都是一些静态资源 //如果访问的内容经常变化，还是需要设置路由 </span>
...
<p>注意事项:</p>
<ol>
<li>index.html 文件为默认打开的资源<br />2. 如果静态资源与路由规则同时匹配，谁先匹配谁就响应<br />3. 路由响应动态资源，静态资源中间件响应静态资源</li>
</ol>
</blockquote>
<p><a name="Oi5UC"></a></p>
<h4 id="_3-获取请求体数据-body-parser" tabindex="-1"><a class="header-anchor" href="#_3-获取请求体数据-body-parser" aria-hidden="true">#</a> 3. 获取请求体数据 body-parser</h4>
<p>express 可以使用 body-parser 包处理请求体			<br />第一步：安装</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>npm i body<span class="token operator">-</span>parser 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>第二步：导入 body-parser 包</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>第三步：获取中间件函数</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//处理 querystring 格式的请求体 </span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>第四步：设置路由中间件，然后使用 request.body 来获取请求体数据</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>app<span class="token punctuation">.</span><span class="token function">post</span><span class="token punctuation">(</span><span class="token string">'/login'</span><span class="token punctuation">,</span> urlParser<span class="token punctuation">,</span> <span class="token punctuation">(</span><span class="token parameter">request<span class="token punctuation">,</span>response</span><span class="token punctuation">)</span><span class="token operator">=></span><span class="token punctuation">{</span> 
...
<p><a name="QRjUZ"></a></p>
<h4 id="_1-1-mongodb-是什么" tabindex="-1"><a class="header-anchor" href="#_1-1-mongodb-是什么" aria-hidden="true">#</a> **1.1 Mongodb 是什么 **</h4>
<p>MongoDB 是一个基于分布式文件存储的数据库	 				 <br /><strong>1.2 数据库</strong>				<br />数据库（DataBase）是按照数据结构来组织、存储和管理数据的 应用程序 <br />数据库的主要作用就是 管理数据 ，对数据进行 增（c）、删（d）、改（u）、查（r） 		 	<br />相比于纯文件管理数据，数据库管理数据有如下特点：</p>
<ol>
<li>速度更快</li>
<li>扩展性更强</li>
<li>安全性更强</li>
</ol>
<p>** Mongodb**操作语法与 JavaScript 类似，容易上手，学习成本低
<a name="W7Ddt"></a></p>
<h3 id="_2-核心概念" tabindex="-1"><a class="header-anchor" href="#_2-核心概念" aria-hidden="true">#</a> 2.核心概念</h3>
<blockquote>
<p>Mongodb 中有三个重要概念需要掌握
数据库（database） 数据库是一个数据仓库，数据库服务下可以创建很多数据库，数据库中可以存
放很多集合
集合（collection） 集合类似于 JS 中的数组，在集合中可以存放很多文档
文档（document） 文档是数据库中的最小单位，类似于 JS 中的对象</p>
</blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>可以通过 JSON 文件来理解 Mongodb 中的概念</p>
<ol>
<li>
<p>一个 JSON 文件 好比是一个 数据库 ，一个 Mongodb 服务下可以有 N 个数据库</p>
</li>
<li>
<p>JSON 文件中的 一级属性的数组值 好比是 集合</p>
</li>
<li>
<p>数组中的对象好比是 文档</p>
</li>
...
<h3 id="_3-命令行安装" tabindex="-1"><a class="header-anchor" href="#_3-命令行安装" aria-hidden="true">#</a> 3.命令行安装</h3>
<p>:::success
brew tap mongodb/brew<br />brew update<br />brew install mongodb-community<a href="/6.0" target="_blank" rel="noopener noreferrer">@6.0 <ExternalLinkIcon/></a> <br />启动 brew services start mongodb-community<a href="/6.0" target="_blank" rel="noopener noreferrer">@6.0 <ExternalLinkIcon/></a> <br />停止 brew services stop mongodb-community<a href="/6.0" target="_blank" rel="noopener noreferrer">@6.0 <ExternalLinkIcon/></a>
:::
<br /><img src="https://cdn.nlark.com/yuque/0/2023/png/22527936/1691393495559-3b1523f0-a0b1-43f3-a5da-79ca6407fd51.png#averageHue=%23282828&amp;clientId=u4229d02e-2f87-4&amp;from=paste&amp;height=528&amp;id=u3771afe1&amp;originHeight=528&amp;originWidth=1424&amp;originalType=binary&amp;ratio=1&amp;rotation=0&amp;showTitle=false&amp;size=541479&amp;status=done&amp;style=none&amp;taskId=ua87d0bba-e4e5-41e0-b71b-bfb45da4ca9&amp;title=&amp;width=1424" alt="image.png"><br /><img src="https://cdn.nlark.com/yuque/0/2023/png/22527936/1691393808755-f37f4a8c-59c5-4cae-b63a-879c0116247a.png#averageHue=%232e3032&amp;clientId=u4229d02e-2f87-4&amp;from=paste&amp;height=63&amp;id=JeVOd&amp;originHeight=154&amp;originWidth=638&amp;originalType=binary&amp;ratio=1&amp;rotation=0&amp;showTitle=false&amp;size=27605&amp;status=done&amp;style=stroke&amp;taskId=u6af5b7e8-bba5-4e2f-879e-30b807f0a5a&amp;title=&amp;width=263" alt="image.png"><br /><img src="https://cdn.nlark.com/yuque/0/2023/png/22527936/1691393792341-07f3e329-fd68-4353-a80a-985c978a4bb6.png#averageHue=%2333362a&amp;clientId=u4229d02e-2f87-4&amp;from=paste&amp;height=700&amp;id=u7b6259eb&amp;originHeight=700&amp;originWidth=1540&amp;originalType=binary&amp;ratio=1&amp;rotation=0&amp;showTitle=false&amp;size=146931&amp;status=done&amp;style=none&amp;taskId=ud35871f1-27dc-4a47-bd23-6f906edc122&amp;title=&amp;width=1540" alt="image.png">
<a name="Golp8"></a></p>
<h3 id="_4-命令行" tabindex="-1"><a class="header-anchor" href="#_4-命令行" aria-hidden="true">#</a> 4.命令行</h3>
<p>:::success
...
<br /> 						<br /> 					<br /> 				<br /> 			<br /> 		<br /> 	
<a name="xYU2p"></a></p>
<h3 id="_5-mongoose" tabindex="-1"><a class="header-anchor" href="#_5-mongoose" aria-hidden="true">#</a> 5.Mongoose</h3>
<p><a name="nSHtx"></a></p>
<h4 id="_1-介绍" tabindex="-1"><a class="header-anchor" href="#_1-介绍" aria-hidden="true">#</a> 1.介绍</h4>
<p>Mongoose是一个对象文档模型库
<a name="WoYEw"></a></p>
<h4 id="_2-作用" tabindex="-1"><a class="header-anchor" href="#_2-作用" aria-hidden="true">#</a> 2.作用</h4>
